...
class JT01 extends Scene {
  ...
  static List<String> dlgFiles = <String>[
    'assets/audio/dialogues/jeff_thread/01/transcript.txt', // Txt file with transcript of each dialogue(1 line - 1 dialogue)
    'audio/dialogues/jeff_thread/01/01.mp3', // Other lines are audio files of each dialogue
    'audio/dialogues/jeff_thread/01/02.mp3',
    'audio/dialogues/jeff_thread/01/03.mp3',
    'audio/dialogues/jeff_thread/01/04.mp3',
    'audio/dialogues/jeff_thread/01/05.mp3',
    'audio/dialogues/jeff_thread/01/06.mp3',
    'audio/dialogues/jeff_thread/01/07.mp3',
    'audio/dialogues/jeff_thread/01/08.mp3',
    'audio/dialogues/jeff_thread/01/09.mp3',
    'audio/dialogues/jeff_thread/01/10.mp3',
    'audio/dialogues/jeff_thread/01/11.mp3',
  ];

  static List<int> chgBackground = <int>[];
  static String ambient;

  JT01(Gameplay gameplay)
